...
* **Product Catalog & Portfolio (`portfolio.html`):** Dynamic therapeutic filtering (Cardiovascular, Anti-Infectives, Gastroenterology, CNS, Respiratory, Dermatology) and modal leaflets.
...
* **Inter Typography System:** Clean UI styling utilizing the Inter font family.

### 3. 📄 Commercial & Technical Proposal Documents
* [`DAD proposal.docx`](DAD%20proposal.docx) & [`DAD_Group_Website_AdminPanel_Proposal_BoldPro.docx`](DAD_Group_Website_AdminPanel_Proposal_BoldPro.docx): Complete technical scope, RACI matrix, 6-week milestone schedule, 50%/50% payment terms, and 1-year maintenance plan.
